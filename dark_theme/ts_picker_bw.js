        ...
        try {
            ...
            this.init = function (datetime, flag) {
                ...
                var calenderHtml = new String(
                        ...
                        "<tr>\n	<td><span class='prevMonth' data-value=" + _this.dt2dtstr(dt_prev_month) + ">" +
                        "<b style='color: #000000;font-weight: bolder;font-size: 18px;cursor: pointer'><</b></span></td>\n" +
                        "<td colspan='5' align='center'>" +
                        "<div><div class='month' style='display:inline-block;margin-right:5px;color:#000000'><span class='header'>" + arr_months[dt_datetime.getMonth()] + "</span><select class='monthSelect' style='display:none;border:1px solid #ccc;width:66px'></select></div><div style='display:inline-block;color:#fff' class='year'><span class='header'>" + dt_datetime.getFullYear() + "</span><select class='yearSelect' style='display:none;border:1px solid #ccc'></select></div></div>" +
                        "</td>\n" +
                        "<td align='center'><span class='nextMonth' data-value=" + _this.dt2dtstr(dt_next_month) + ">" +
                        "<b style='color: #000000;font-weight: bolder;font-size: 18px;cursor: pointer'>></b></span></td>\n</tr>\n"
                        );
